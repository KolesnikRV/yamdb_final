# Generated by Django 3.0.5 on 2021-06-10 02:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[api.validators.year_validator], verbose_name='Год выхода')),
                ...
                ('genre', models.ManyToManyField(to='api.Genre', verbose_name='Жанры')),
            ],
            options={
